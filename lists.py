...
# if an attempt is made to access and element outside of the
...
# The pop function can also be used to remove and return a element to a list.
# By default, it removes only the last element of the list.
last = names.pop()
print(last)
print(names, ' - pop function')

# To remove an element from a specific position of a list, the index of the element
# may be passed as an arguement to the pop function 
first = names.pop(0)
print(first)
